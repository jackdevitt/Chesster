...
public class chessGUI {
   ...
   public static void getGameMode() {
      ...
      Dimension ss = Toolkit.getDefaultToolkit().getScreenSize();
      chessGUI.bullet.setBounds(((ss.width / 6) * 1) - 225, ss.height / 2 - 150, 450, 450);
      chessGUI.standard.setBounds(((ss.width / 6) * 3) - 225, ss.height / 2 - 150, 450, 450);
      chessGUI.tournament.setBounds(((ss.width / 6) * 5) - 225, ss.height / 2 - 150, 450, 450);
      ...
      try {
         ...
         chessGUI.bulletImage = chessGUI.bulletImage.getScaledInstance(450, 450,  java.awt.Image.SCALE_SMOOTH);
         chessGUI.standardImage = ImageIO.read(new File("images/Standard.png"));
         chessGUI.standardImage = chessGUI.standardImage.getScaledInstance(450, 450,  java.awt.Image.SCALE_SMOOTH);
         chessGUI.tournamentImage = ImageIO.read(new File("images/Tournament.png"));
         chessGUI.tournamentImage = chessGUI.tournamentImage.getScaledInstance(450, 450,  java.awt.Image.SCALE_SMOOTH);
   ...
   public static void handleGameEnd(int gameState) {
      ...
      backToMenu.setBounds((ss.width / 2) - 100 - 450, ss.height - 350, 200, 100);
      ...
      playAgainMenu.setBounds((ss.width / 2) - 100 + 450, ss.height - 350, 200, 100);
